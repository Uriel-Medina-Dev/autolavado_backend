...
@rol.post("/rol/", response_model=schemas.schema_rols.Rol, tags=["Roles"])
...
@rol.put("/rol/{rol_id}", response_model=schemas.schema_rols.Rol, tags=["Roles"])
...
@rol.delete("/rol/{rol_id}", tags=["Roles"])
